...
public class ScreenSizeUtil {
	...
	public static ScreenSize getScreenSize(){
		WindowManager w = (WindowManager) ModelManager.getContext().getSystemService(Context.WINDOW_SERVICE);
		...
		DisplayMetrics dm = ModelManager.getContext().getResources().getDisplayMetrics();
    ...
    public static int getStatusBarHeight() {
        Resources resources = ModelManager.getInst().getContext().getResources();
        int result = 0;
    ...
    public static int getNavBarHeight() {
        Context context = ModelManager.getInst().getContext();
    ...
    public static boolean hasPermanentMenuKey() {
        boolean hasMenuKey;
        ViewConfiguration vc = ViewConfiguration.get(ModelManager.getContext());
